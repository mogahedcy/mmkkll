...
export default function ProjectsPage() {
  ...
  const categories = [
    ...
    { id: 'mazallat', name: 'المظلات' },
    { id: 'pergolas', name: 'البرجولات' },
    { id: 'renovation', name: 'الترميم' },
    { id: 'sandwich-panel', name: 'الساندوتش بانل' },
    { id: 'sawater', name: 'السواتر' },
    { id: 'byoot-shaar', name: 'بيوت الشعر' },
    { id: 'khayyam', name: 'الخيام' }
  ];
