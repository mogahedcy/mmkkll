...
export const metadata: Metadata = {
  ...
  title: {
    default: "محترفين الديار العالمية | خبرة +15 عاماً في جدة",
    template: "%s | محترفين الديار العالمية"
  },
  description:
    "محترفين الديار العالمية - الرائدون في جدة والمملكة العربية السعودية. خبرة +15 عاماً في: مظلات سيارات، برجولات حدائق، سواتر، ساندوتش بانل، ترميم، تنسيق حدائق، بيوت شعر تراثية. ضمان 10 سنوات وخدمة 24/7.",
  keywords:
